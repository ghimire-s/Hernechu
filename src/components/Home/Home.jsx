    ...
    return (
      <React.Fragment>
        ...
        <div className="tile-container">
          <Carrousal title="Movies" data={this.state.data}></Carrousal>
          <Carrousal title="Songs" data={this.state.data}></Carrousal>
          <Carrousal title="Trailers" data={this.state.data}></Carrousal>
        </div>
      </React.Fragment>
    );
  }
