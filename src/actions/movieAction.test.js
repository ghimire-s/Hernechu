...
describe('Fetching movie actions', () => {
    const ds = data;
    const youtube_data = ds.filter(item => item.youtube !== "")
    const new_match = [{
        "name": "Loot",
    ...
    it('fetchMovies should fetch all movie', () => {
        ...
        expect(actions.fetchMovies('all')).toEqual(expectedAction)
    ...
    it('fetchMovies should fetch all movie', () => {
        ...
        expect(actions.fetchMovies('Youtube')).toEqual(expectedAction)
